...
@NamedQuery(
        name = "entities.Projet.nomProjet",
        query="Select p.nomProjet From Projet p where p.codeProjet=:cp"
)
...
public class Projet {
    ...
    @ManyToMany
    @JoinTable(name = "PROJETSTERMINES",joinColumns = {@JoinColumn(name = "CODEPROJET")},inverseJoinColumns = {@JoinColumn(name = "IDEMP")})
