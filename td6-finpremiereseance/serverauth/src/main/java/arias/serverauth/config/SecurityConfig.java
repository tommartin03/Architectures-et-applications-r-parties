package arias.serverauth.config;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
                                                   JwtDecoder decoder,
                                                   JwtAuthenticationConverter jac) throws Exception {
    ...
    Function<UserDetails,String> genereTokenFunction(JwtEncoder jwtEncoder) {
        ...
        return user -> {
            ...
            // Les listes de roles de l'utilisateur sous forme de chaine de caractères
    ...
    UserDetailsManager users(DataSource dataSource,PasswordEncoder passwordEncoder) {
        ...
        // on est en mode test, on crée l'admin à la volée
